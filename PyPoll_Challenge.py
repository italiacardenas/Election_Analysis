...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > largest_count) and (county_vote_percentage > largest_percentage):
    ...
    largest_county_turnout_summary = (
        ...
        f"Largest Vote Turnout: {largest_count:,}\n"
        f"Largest Percentage Turnout: {largest_percentage:.1f}%\n"
        f"-------------------------\n")
